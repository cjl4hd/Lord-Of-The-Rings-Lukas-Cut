...
twotowersCuts = [
    ...
    [5493,   14138    ,0,0,0,0,[0,0],"Frodo wakes, walking with Sam"],
    [14139,  16060    ,0,1,0,0,[0,0],"Frodo Sam fight Gollum"],#not very scary
    [16061,  21216    ,0,0,0,0,[0,0],"Frodo Sam walk with Gollum"],
    [21217,  24612    ,0,0,1,0,[0,0],"Merry Pippin with orcs"],
    [24613,  27717    ,0,0,0,0,[0,0],"Aragorn, Gimli, Legolas trailing orcs"],
    ...
    [139571, 150546   ,0,0,0,0,[0,0],"FSG walking see elephants"],
    ...
    [256056, 258576   ,0,0,0,0,[0,0],"Ents decided to do nothing"],
    [258577, 267267   ,2,1,0,0,[0,0],"Helm's Deep, falling back to keep"],
    [267268, 269307   ,0,0,0,0,[0,0],"Treebeard walking to western forest, changes direction"],
    ...
    [277370, 277971   ,0,0,0,0,[0,0],"Helm's Deep fortress gate defense"],
    [277972, 278010   ,0,1,1,0,[0,0],"Orcs hit gate 1"],
    [278011, 278663   ,0,0,0,0,[0,0],"Aragorn pep talk"],
    [278664, 278735   ,0,1,1,0,[0,0],"Orcs hit gate 2"],
    [278736, 279044   ,0,0,0,0,[0,0],"Women and children make for the mountain pass"],
    ...
    [296628, 309063   ,0,0,0,0,[0,0],"MP take control of Isenguard"],
...
returnofthekingCuts = [
    ...
    [6758,   7119     ,0,0,0,0,[0,0],"Smeagol puts on ring"],
    [7120,   9212     ,0,1,0,0,[0,0],"Smeagol cursed"],
    [9213,   13458    ,0,0,0,0,[0,0],"FSG continue journey"],
    [13459,  21562    ,0,0,0,0,[0,0],"MP Isenguard met by ALGG"],
    [21563,  25220    ,1,1,0,0,[0,0],"Saruman sends fireball, dies"],
    [25221,  33205    ,0,0,0,0,[0,0],"Pippin takes stone, they go to Rohan"],
    ...
    [45255,  53379    ,0,0,0,0,[0,0],"Gandalf scoops up stone, he and Pippin leave"],
    ...
    [65530,  72373    ,0,0,0,0,[0,0],"Pippin volunteers service, Galdolf and Pippin talk"],
    ...
    [85374,  86880    ,0,0,0,0,[0,0],"FSG climbing away from Minas Morgul"],
    ...
    [134438,  134948  ,0,0,0,0,[0,0],"Gandalf sad"],
    ...
    [251892,  254023  ,0,0,0,0,[0,0],"Eowyn recovers"],
