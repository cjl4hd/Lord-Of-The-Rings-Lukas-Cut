...
fellowshipCuts = [
    ...
    [132202, 133432   ,0,0,0,0,"Sauron finger cut, isildor says no"],#Shows sword cutting finger, but not much is seen.
...
returnofthekingCuts = [
    ...
    [105346,  111294  ,0,0,0,0,"Gandolf enables escape from lost city"],
    [111295,  114167  ,0,0,0,0,"FSG continue climb"],
    [114168,  114727  ,0,0,1,1,"Nasgul,Orcs in lost city"],
    ...
    [134438,  134948  ,0,0,0,0,"Gandolf sad"],
    ...
    [184993,  188290  ,0,0,0,0,"Frodo Golum enter Shilab's Lair"],
    [188291,  188885  ,0,1,0,0,"Frodo sees bones, dead bird"],
    [188886,  189965  ,0,0,0,0,"Sam finds Lambas"],
    [189966,  193853  ,1,1,0,0,"Frodo fights Shilab, escapes"],
    [193854,  196130  ,1,1,0,0,"Frodo fights Golum, Golum falls"],
    ...
    [205508,  210877  ,0,1,0,0,"Frodo stung, sam fights Shilab"],
    ...
    [221751,  223504  ,0,0,0,0,"Mary ready to ride"],
    ...
    [303461,  306619  ,1,1,1,1,"Nasgul fly to Mt Doom, Frodo Golum fight, battle continues"],
    [306620,  308794  ,0,0,0,0,"Frodo Golum fall, Golum dies"],#A little scary with golum in lava, but key plot point
